...
print("main interpreter")
    ...
    std::thread t1{f, s1.interp(), "  [sub-interpreter1]  "};
    std::thread t2{f, s2.interp(), "  [sub-interpreter2]  "};
    std::thread t3{f, s3.interp(), "  [sub-interpreter3]  "};
    std::thread t4{f, s4.interp(), "  [sub-interpreter4]  "};
